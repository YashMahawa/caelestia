...
depends=('caelestia-cli' 'caelestia-shell'
         ...
         'wl-clipboard' 'cliphist' 'grim' 'slurp' 'swappy' 'fuzzel'
         'brightnessctl' 'ddcutil' 'networkmanager' 'libnotify' 'playerctl'
         'gpu-screen-recorder' 'dart-sass'
         'inotify-tools' 'app2unit' 'wireplumber' 'trash-cli'
